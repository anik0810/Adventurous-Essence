  ...
  return (
    <>
        <div className='guide'>
            ...
            <div className='right'>
                <div className='expert'><img src={mal}/><br/><h>Santu Chakraborty</h></div>
                <div className='expert'><img src={him}/><br/><h>Some One</h></div>
                <div className='expert'><img src={souvik}/><br/><h>Souvik Aditya</h></div>
            </div>
        </div>
    </>
  )
